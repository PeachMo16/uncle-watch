...
Updated 2026-09-07 by [the weekly workflow](.github/workflows/leaderboard.yml)
on the tickers in [WATCHLIST](WATCHLIST). Scoring v3. Not investment advice —
...
|---|---:|---|---|---|---|---:|
| $QUBT | **83** | `████████··` | cluster density (100) | none | $11.70–$15.62 | $8.01 |
| $RGTI | **73** | `███████···` | cluster density (100) | ↑ yes | $1.33–$4.58 | $15.20 |
| $IONQ | **55** | `██████····` | cluster density (100) | ↑ yes | $5.80–$13.21 | $39.52 |
| $POET ⚠ FPI | **28** | `███·······` | dilution engine (100) | none | — | $7.92 |
| $GOOG | **17** | `██········` | dilution engine (100) | none | — | $335.31 |
