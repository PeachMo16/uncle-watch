...
// a Form 4/A refiles (and may correct) the transactions of the original Form 4 —
// within a (issuer, owner set, period) group, the latest amendment supersedes the originals
export function dedupeAmendments(filings) {
  ...
  return Object.values(groups).flatMap((g) => {
    ...
    return [amends.sort((a, b) => a.filingDate.localeCompare(b.filingDate)).pop()];
  });
}
